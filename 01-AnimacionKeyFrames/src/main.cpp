...
float rotBuzzHead = 0.0, rotBuzzHip = 0.0, rotBuzzRightArm1 = 0.0, rotBuzzRightArm2 = 0.0,
	rotBuzzRightForeArm = 0.0, rotBuzzRightHand = 0.0, rotBuzzLeftArm1 = 0.0, rotBuzzLeftArm2 = 0.0,
	rotBuzzLeftForeArm = 0.0, rotBuzzLeftHand = 0.0, rotBuzzRightThigh = 0.0, rotBuzzRightCalf = 0.0,
	rotBuzzLeftThigh = 0.0, rotBuzzLeftCalf = 0.0;
int modelSelected = 0;
...
//joints interpolation Buzz Lego
//Descomentar
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	shaderMulTextures.initialize("../Shaders/iluminacion_texture_res.vs", "../Shaders/multipleLights_MultiTexture.fs");
	...
	modelHeliTra.loadModel("../models/Helicopter/Mi_24_tra.obj");
	...
	boxMultiTexture.setShader(&shaderMulTextures);
	boxMultiTexture.setPosition(glm::vec3(0.0f, 2.0f, 0.0f));
	...
	if (data) {
		...
		std::cout << "Fallo al cargar la textura" << "LandingPad" ;
	//Liberamos memoria
	...
	if (data) {
		...
		std::cout << "Fallo al cargar la textura" << "Sponge";
	//Liberamos memoria
...
void applicationLoop() {
	...
	while (psi) {
		...
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); //limpia el buffer para que se actualice la pantalla es al inicio de cada frame

		glm::mat4 projection = glm::perspective(glm::radians(45.0f),
			(float)screenWidth / (float)screenHeight, 0.01f, 100.0f);	//el radio de apertura es el FOV plano cercano y plano lejano
		...
		modelMatrixHeliTra = glm::translate(modelMatrixHeliTra, glm::vec3(0.399367f, 2.09309f, -5.64931f));
		...
		glActiveTexture(GL_TEXTURE0);
		glm::mat4 modelMatrixLamboLeftDor = glm::mat4(modelMatrixLamboChasis); //depende del chasis, crea una copia local de esta
		/*modelMatrixLamboLeftDor = glm::translate(modelMatrixLamboLeftDor, glm::vec3(1.08676, 0.707316, 0.982601));
		modelMatrixLamboLeftDor = glm::rotate(modelMatrixLamboLeftDor, glm::radians(dorRotCount), glm::vec3(1.0, 0, 0));
		modelMatrixLamboLeftDor = glm::translate(modelMatrixLamboLeftDor, glm::vec3(-1.08676, -0.707316, -0.982601));*/
		modelMatrixLamboLeftDor = glm::translate(modelMatrixLamboLeftDor, glm::vec3(1.08746f, 0.704807f, 0.978686f)); //coordenadas del pivote
		modelMatrixLamboLeftDor = glm::rotate(modelMatrixLamboLeftDor, glm::radians(dorRotCount), glm::vec3(1.0f, 0.0f, 0.0f)); //rotacion
		modelMatrixLamboLeftDor = glm::translate(modelMatrixLamboLeftDor, glm::vec3(-1.08746f, -0.704807f, -0.978686f)); //Regreso de traslacion del pivote
		...
		modelMatrizHip = glm::rotate(modelMatrizHip, rotBuzzHip, glm::vec3(0, 1, 0)); //pendiente
		modelBuzzHip.render(modelMatrizHip);

		glm::mat4 modelMatrizRightArm = glm::mat4(modelMatrixTorso);
		modelMatrizRightArm = glm::translate(modelMatrizRightArm,
			glm::vec3(-0.179974, 0.577592, -0.022103));
		modelMatrizRightArm = glm::rotate(modelMatrizRightArm,
			rotBuzzRightArm1, glm::vec3(1, 0, 0));
		modelMatrizRightArm = glm::rotate(modelMatrizRightArm,
			rotBuzzRightArm2, glm::vec3(0, 0, 1));
		modelMatrizRightArm = glm::translate(modelMatrizRightArm,
			 glm::vec3(0.179974, -0.577592, 0.022103));
		modelBuzzRightArm.render(modelMatrizRightArm);
		glm::mat4 modelMatrizRightForearm = glm::mat4(modelMatrizRightArm);
		modelMatrizRightForearm = glm::translate(modelMatrizRightForearm,
			glm::vec3(-0.298368, 0.583773, 0.008465));
		modelMatrizRightForearm = glm::rotate(modelMatrizRightForearm,
			rotBuzzRightForeArm, glm::vec3(0, 1, 0));
		modelMatrizRightForearm = glm::translate(modelMatrizRightForearm,
			glm::vec3(0.298368, -0.583773, -0.008465));
		modelBuzzRightForearm.render(modelMatrizRightForearm);
		glm::mat4 modelMatrizRightHand = glm::mat4(modelMatrizRightForearm);
		modelMatrizRightHand = glm::translate(modelMatrizRightHand,
			glm::vec3(-0.416066, 0.587046, 0.076258));
		modelMatrizRightHand = glm::rotate(modelMatrizRightHand,
			rotBuzzRightHand, glm::vec3(1, 0, 0));
		modelMatrizRightHand= glm::translate(modelMatrizRightHand,
			glm::vec3(0.416066, -0.587046, -0.076258));
		modelBuzzRightHand.render(modelMatrizRightHand);

		glm::mat4 modelMatrizLeftArm = glm::mat4(modelMatrixTorso);
		modelMatrizLeftArm = glm::translate(modelMatrizLeftArm,
			glm::vec3(0.180042f, 0.577417f,	-0.030163f));
		modelMatrizLeftArm = glm::rotate(modelMatrizLeftArm,
			rotBuzzLeftArm1, glm::vec3(1, 0, 0));
		modelMatrizLeftArm = glm::rotate(modelMatrizLeftArm,
			rotBuzzLeftArm2, glm::vec3(0, 0, -1));
		modelMatrizLeftArm = glm::translate(modelMatrizLeftArm,
			glm::vec3(-0.180042, -0.577417, 0.030163));
		modelBuzzLeftArm.render(modelMatrizLeftArm);

		glm::mat4 modelMatrizLeftForearm = glm::mat4(modelMatrizLeftArm);
		modelMatrizLeftForearm = glm::translate(modelMatrizLeftForearm,
			glm::vec3(0.29534, 0.584045, 0.002148));
		modelMatrizLeftForearm = glm::rotate(modelMatrizLeftForearm,
			rotBuzzLeftForeArm, glm::vec3(0, -1, 0));
		modelMatrizLeftForearm = glm::translate(modelMatrizLeftForearm,
			glm::vec3(-0.29534f, -0.584045, -0.002148));
		modelBuzzLeftForearm.render(modelMatrizLeftForearm);

		glm::mat4 modelMatrizLeftHand = glm::mat4(modelMatrizLeftForearm);
		modelMatrizLeftHand = glm::translate(modelMatrizLeftHand,
			glm::vec3(0.416066, 0.587046, 0.076258));
		modelMatrizLeftHand = glm::rotate(modelMatrizLeftHand,
			rotBuzzLeftHand, glm::vec3(-1, 0, 0));
		modelMatrizLeftHand = glm::translate(modelMatrizLeftHand,
			glm::vec3(-0.416066, -0.587046, -0.076258));
		modelBuzzLeftHand.render(modelMatrizLeftHand);

		glm::mat4 modelMatrizRightThigh = glm::mat4(modelMatrizHip);
		modelMatrizRightThigh = glm::translate(modelMatrizRightThigh, glm::vec3(-0.064503f, 0.364435f, 0.006700f));
		modelMatrizRightThigh = glm::rotate(modelMatrizRightThigh, rotBuzzRightThigh, glm::vec3(1.0f, 0.0f, 0.0f));
		modelMatrizRightThigh = glm::translate(modelMatrizRightThigh, glm::vec3(0.064503f, -0.364435f, -0.006700f));
		modelBuzzRightThigh.render(modelMatrizRightThigh);
		glm::mat4 modelMatrizRightCalf = glm::mat4(modelMatrizRightThigh);
		modelMatrizRightCalf = glm::translate(modelMatrizRightCalf, glm::vec3(-0.065466f, 0.216398f, -0.007231f));
		modelMatrizRightCalf = glm::rotate(modelMatrizRightCalf, rotBuzzRightCalf, glm::vec3(1.0f, 0.0f, 0.0f));
		modelMatrizRightCalf = glm::translate(modelMatrizRightCalf, glm::vec3(0.065466f, -0.216398f, 0.007231f));
		...
		modelMatrizLeftThigh = glm::translate(modelMatrizLeftThigh, glm::vec3(0.064503f, 0.364435f, 0.006700f));
		modelMatrizLeftThigh = glm::rotate(modelMatrizLeftThigh, rotBuzzLeftThigh, glm::vec3(1.0f, 0.0f, 0.0f));
		modelMatrizLeftThigh = glm::translate(modelMatrizLeftThigh, glm::vec3(-0.064503f, -0.364435f, -0.006700f));
		modelBuzzLeftThigh.render(modelMatrizLeftThigh);
		glm::mat4 modelMatrizLeftCalf = glm::mat4(modelMatrizLeftThigh);
		modelMatrizLeftCalf = glm::translate(modelMatrizLeftCalf, glm::vec3(0.065466f, 0.216398f, -0.007231f));
		modelMatrizLeftCalf = glm::rotate(modelMatrizLeftCalf, rotBuzzLeftCalf, glm::vec3(1.0f, 0.0f, 0.0f));
		modelMatrizLeftCalf = glm::translate(modelMatrizLeftCalf, glm::vec3(-0.065466f, -0.216398f, 0.007231f));
		modelBuzzLeftCalf.render(modelMatrizLeftCalf);
		glm::mat4 modelMatrizLeftFoot = glm::mat4(modelMatrizLeftCalf);
		modelBuzzLeftFoot.render(modelMatrizLeftFoot);

		glm::mat4 modelMatrizLeftWing1 = glm::mat4(modelMatrixTorso);
		modelBuzzLeftWing1.render(modelMatrizLeftWing1);
		glm::mat4 modelMatrizLeftWing2 = glm::mat4(modelMatrizLeftWing1);
		modelBuzzLeftWing2.render(modelMatrizLeftWing2);

		glm::mat4 modelMatrizRightWing1 = glm::mat4(modelMatrixTorso);
		modelBuzzRightWing1.render(modelMatrizRightWing1);
		glm::mat4 modelMatrizRightWing2 = glm::mat4(modelMatrizRightWing1);
		modelBuzzRightWing2.render(modelMatrizRightWing2);
		...
		if (record && modelSelected == 2) {
			...
			if (record && modelSelected == 3) {
				...
				rotBuzzLeftThigh = interpolate(keyFramesBuzzJoints, indexFrameBuzzJoints, indexFrameBuzzJointsNext, 12, interpolationBuzzJoints);
				rotBuzzLeftCalf = interpolate(keyFramesBuzzJoints, indexFrameBuzzJoints, indexFrameBuzzJointsNext, 13, interpolationBuzzJoints);
			}
		}
		...
		case 1:
			...
			break;
		case 2:
			modelMatrixEclipse = glm::translate(modelMatrixEclipse, glm::vec3(0.0f, 0.0f, 0.025f));//para la curva
