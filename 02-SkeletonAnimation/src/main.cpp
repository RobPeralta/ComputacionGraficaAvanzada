...
glm::mat4 modelMatrixCowboy = glm::mat4(1.0f); //crea una matriz de transformacion con puros 1 en la diagonal
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Cyborg
	cyborgModelAnimate.loadModel("../models/cyborg/Practica2prueba.fbx");
...
void applicationLoop() {
	...
	modelMatrixGuardian = glm::rotate(modelMatrixGuardian, glm::radians(90.0f), glm::vec3(-1.0f, 0, 0));
